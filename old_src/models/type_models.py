...
from old_src.models.components.gear import GearSlot
from old_src.models.components.inventory import ItemStack
from old_src.models.items.gear import Gear
