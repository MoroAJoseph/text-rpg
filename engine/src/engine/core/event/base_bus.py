...
class BaseEventBus(Generic[TName, TEvent]):
    ...
    def process(self) -> None:
        """
        Swaps the double-buffers and flushes the current queue,
        triggering all relevant subscribers.
        """

        # Swap buffers: events emitted during this process call go to the new next_queue
        ...
        while self._current_queue:
            ...
            name: Optional[TName] = self._get_event_name(event)
